module.exports = api => {
    // In test environment, target Node directly so async/await is not transpiled
    // to generators (which would require regeneratorRuntime, absent from .mocharc.yml).
    // Webpack builds are unaffected: webpack overrides NODE_ENV to production/development.
